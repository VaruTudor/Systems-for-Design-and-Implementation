...
public class GunProviderController {
    ...
    List<GunProviderDto> getAllGunProviders() {
        ...
        List result = new ArrayList<>(
                gunProviderConverter.convertModelsToDtos(
    ...
    @RequestMapping(value = "/gun-providers/getByName")
    GunProviderDto getGunProviderByName(String name) {
        return gunProviderConverter.convertModelToDto(
                gunProviderService.getGunProviderByName(name));
    }
